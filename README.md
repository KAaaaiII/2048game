...
游戏类``game2048``,包括数据成员整型二维数组``Map[N+2][N+2]``,用于存储网格中的数字，整型变量``score``、``maxsq``、``sumsq``，分别表示玩家得分、场上最大方块数值、场上方块数目总和，以及一个字符串``player``，存储玩家用户名
...
<img src="https://i.miji.bid/2023/12/26/12704259eab0ee4df19e31dca67392dd.png" style="zoom:80%;" />
